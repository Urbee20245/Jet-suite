...
const ToolButton: React.FC<{
  ...
  const tourId = tool.id === 'ask-boris' ? 'boris' : tool.id;
...
const CollapsibleCategory: React.FC<{
  ...
  const tourId = 
    category.name === 'Business Foundation' ? 'analyze-section' :
    category.name === 'Marketing and Brand Strategy' ? 'attract-section' :
    category.name === 'Customer Engagement' ? 'trust-section' :
    undefined;
