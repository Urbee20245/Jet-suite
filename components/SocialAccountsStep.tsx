...
// Social Media Platform Icons (SVG)
...
export const SocialAccountsStep: React.FC<SocialAccountsStepProps> = ({
  ...
  return (
    <div className="bg-brand-card p-6 sm:p-8 rounded-xl shadow-lg">
      ...
      {/* Connection Status Summary with Real Icons */}
      {!loading && connections.length > 0 && (
        <div className="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg">
          <p className="text-green-800 font-semibold flex items-center mb-3">
          ...
          <div className="flex flex-wrap gap-2">
            {connections.map((conn) => {
              ...
              return (
                <div
                  key={conn.id}
                  className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-full border border-green-200"
                >
