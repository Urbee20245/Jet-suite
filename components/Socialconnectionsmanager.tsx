...
// Social Media Platform Icons (SVG) - Same as SocialAccountsStep
    ...
    <div>
      ...
      {availableToConnect.length > 0 && (
        <button
          ...
          className="w-full bg-gradient-to-r from-accent-blue to-accent-purple text-white font-bold py-3 px-4 rounded-lg transition hover:shadow-lg"
        >
          + Connect Account
        </button>
      )}
