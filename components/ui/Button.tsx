...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: 'bg-accent-purple hover:bg-accent-purple/90 text-white shadow-md shadow-accent-purple/20',
    secondary: 'bg-white hover:bg-brand-light border-2 border-accent-purple text-accent-purple shadow-sm',
    tertiary: 'bg-transparent hover:bg-brand-light text-accent-purple hover:text-accent-purple/80',
