...
const DnaReviewAndSaved: React.FC<{ visualDna: BusinessDna; detailedDna: BrandDnaProfile; isEditable: boolean; onVisualDnaChange: (newDna: BusinessDna) => void; onDetailedDnaChange: (newProfile: BrandDnaProfile) => void; onSave: () => void; onCancel?: () => void; onRestart: () => void; onEdit: () => void; dnaLastUpdatedAt?: string; detectedGbp: BusinessSearchResult | null; isGbpConfirmed: boolean; onConfirmGbp: () => void; onRejectGbp: () => void; isDnaEditing: boolean; editableBrandProfile: BrandDnaProfile | null; }> = ({ visualDna, detailedDna, isEditable, onVisualDnaChange, onDetailedDnaChange, onSave, onCancel, onRestart, onEdit, dnaLastUpdatedAt, detectedGbp, isGbpConfirmed, onConfirmGbp, onRejectGbp, isDnaEditing, editableBrandProfile }) => {
