...
import { ChevronDownIcon, ChevronUpIcon } from '../components/icons/MiniIcons';
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        <div className="bg-brand-card rounded-xl shadow-lg border border-brand-border/50 overflow-hidden">
          <button
            onClick={() => setSocialExpanded(!socialExpanded)}
            className="w-full p-6 sm:p-8 flex items-center justify-between hover:bg-brand-light/30 transition-colors duration-200"
          >
          ...
          {socialExpanded && (
            <div className="px-6 sm:px-8 pb-6 sm:pb-8 border-t border-brand-border/30">
              <div className="pt-6">
