...
export const FaqPage: React.FC<FaqPageProps> = ({ navigate }) => {
  ...
  const allFaqs = [
      ...
      { category: 'general', q: "Who is JetSuite for?", a: "JetSuite is for any entrepreneur who wants to grow their business online. Whether you're a local service business, e-commerce store, or startup, our tools help you succeed. Don't have a Google Business Profile? We'll guide you through setting one up from scratch." },
      { category: 'general', q: "Who is JetSuite NOT for?", a: "JetSuite is designed for entrepreneurs who want to grow their business using our comprehensive tools. However, it requires a desktop, laptop, or tablet to use effectively—it's not optimized for cell phone/mobile use due to the extensive nature of the dashboard and features." },
      { category: 'general', q: "Do I need to install anything?", a: "No. JetSuite is 100% cloud-based. You can access it from any web browser on your desktop, laptop, or tablet." },
      ...
      <section className="py-24 px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8 max-w-4xl mx-auto">
              ...
              <div className="flex-1 bg-slate-800/50 p-8 rounded-2xl border border-slate-700 hover:border-blue-500/50 transition-colors">
                  ...
                  <button onClick={() => navigate('/get-started')} className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 px-6 rounded-lg transition-colors shadow-lg shadow-blue-600/20">
                      Get Started
                  </button>
