  ...
  return (
    <div className="min-h-screen bg-brand-bg">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-extrabold text-brand-text mb-4">Privacy Policy</h1>
        ...
        {/* Table of Contents */}
        <section className="mb-8 bg-brand-light p-6 rounded-lg border border-brand-border">
          <h2 className="text-2xl font-bold text-brand-text mb-4">Table of Contents</h2>
        ...
        <section id="information-collection" className="mb-8">
          ...
          <h3 className="text-xl font-semibold text-brand-text mb-3">1.1 Personal Information You Provide</h3>
          <p className="text-brand-text mb-4">
            We collect information that you voluntarily provide to us when you:
          </p>
          <ul className="list-disc list-inside space-y-2 text-brand-text mb-6 ml-4">
          ...
          <h3 className="text-xl font-semibold text-brand-text mb-3">1.2 Information Collected Automatically</h3>
          <p className="text-brand-text mb-4">
          ...
          <h3 className="text-xl font-semibold text-brand-text mb-3">1.3 Information from Third-Party Services</h3>
          <p className="text-brand-text mb-4">
          ...
          <p className="text-brand-text mb-4 bg-yellow-50 border-l-4 border-yellow-400 p-4">
        ...
        <section id="information-sharing" className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">3. Disclosure of Your Information</h2>
          <p className="text-brand-text mb-4">
            We may share your information in the following situations:
          </p>
          
          <h3 className="text-xl font-semibold text-brand-text mb-3">3.1 Service Providers</h3>
          <p className="text-brand-text mb-4">
          ...
          <h3 className="text-xl font-semibold text-brand-text mb-3">3.2 Social Media Platforms</h3>
          <p className="text-brand-text mb-4">
          ...
          <h3 className="text-xl font-semibold text-brand-text mb-3">3.3 Legal Requirements</h3>
          <p className="text-brand-text mb-4">
          ...
          <h3 className="text-xl font-semibold text-brand-text mb-3">3.4 Business Transfers</h3>
          <p className="text-brand-text mb-4">
          ...
          <h3 className="text-xl font-semibold text-brand-text mb-3">3.5 With Your Consent</h3>
          <p className="text-brand-text mb-4">
            We may share your information for any other purpose with your explicit consent.
          </p>

          <p className="text-brand-text mt-6 bg-blue-50 border-l-4 border-blue-400 p-4">
        ...
        <section id="third-party-services" className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">4. Third-Party Services</h2>
          <p className="text-brand-text mb-4">
        ...
        <section id="data-security" className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">5. Security of Your Information</h2>
          <p className="text-brand-text mb-4">
        ...
        <section id="data-retention" className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">6. Data Retention</h2>
          <p className="text-brand-text mb-4">
        ...
        <section id="user-rights" className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">7. Your Rights</h2>
          <p className="text-brand-text mb-4">
        ...
        <section id="cookies" className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">8. Cookies and Tracking Technologies</h2>
          <p className="text-brand-text mb-4">
        ...
        <section id="international" className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">10. International Data Transfers</h2>
          <p className="text-brand-text mb-4">
        ...
        <section id="california" className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">11. California Privacy Rights (CCPA)</h2>
          <p className="text-brand-text mb-4">
        ...
        <section id="gdpr" className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">12. GDPR Compliance (European Users)</h2>
          <p className="text-brand-text mb-4">
            If you are located in the European Economic Area (EEA), you have rights under the General Data Protection 
            Regulation (GDPR):
          </p>
          
          <h3 className="text-xl font-semibold text-brand-text mb-3">Legal Basis for Processing</h3>
          <p className="text-brand-text mb-4">
          ...
          <h3 className="text-xl font-semibold text-brand-text mb-3">Your GDPR Rights</h3>
          <ul className="list-disc list-inside space-y-2 text-brand-text mb-6 ml-4">
        ...
        <section id="contact" className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">13. Contact Us</h2>
          <p className="text-brand-text mb-4">
