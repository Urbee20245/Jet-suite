  ...
  return (
    <div className="min-h-screen bg-brand-bg">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-extrabold text-brand-text mb-4">Terms of Service</h1>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">2. Service Description</h2>
          <p className="text-brand-text mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">3. Account Registration and Security</h2>
          <p className="text-brand-text mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">4. Subscription and Payment Terms</h2>
          <p className="text-brand-text mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">5. Acceptable Use Policy</h2>
          <p className="text-brand-text mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">6. Content and Intellectual Property</h2>
          <p className="text-brand-text mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">7. Third-Party Services and Integrations</h2>
          <p className="text-brand-text mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">8. Disclaimers and Limitations</h2>
          <div className="bg-red-50 border-l-4 border-red-400 p-4 mb-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-brand-text mb-4 ml-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">10. Indemnification</h2>
          <p className="text-brand-text mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">11. Termination</h2>
          <p className="text-brand-text mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">12. Changes to Terms</h2>
          <p className="text-brand-text mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">13. Governing Law and Dispute Resolution</h2>
          <p className="text-brand-text mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">14. Miscellaneous</h2>
          <p className="text-brand-text mb-4">
        ...
        {/* Section 15: Contact */}
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-brand-text mb-4">15. Contact Information</h2>
        ...
        {/* Acceptance */}
        <section className="mb-8 bg-blue-50 border-l-4 border-blue-400 p-4">
